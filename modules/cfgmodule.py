...
# Some of the code in this file is taken from the wonderful work of Sami Alaoui Kendil.
# Below is the original header of the code.
# I've made changes in the code to support the models shipping in indian subcontinent
# and to accommodate it for a flask based web-app environment.
print("")
# ========= ORG HEADER START ======================================
